	...
	<div class="container">
		...
		<form method="post" action="/lesson04/ex02/add_student">
			...
			<div class="form-group">
				...
				<input type="text" id="phoneNumber" name="phoneNumber" class="form-control col-3" placeholder="010-1111-2222">
			</div>
			<div class="form-group">
			...
			<button type="submit" class="btn btn-success" vlaue="추가">추가</button>
		</form>
</body>
</html>